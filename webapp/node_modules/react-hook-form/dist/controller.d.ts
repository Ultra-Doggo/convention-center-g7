...
declare const Controller: <TAs extends "input" | "select" | "textarea" | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | React.ComponentClass<any, any> | React.FunctionComponent<any>, TFieldValues extends Record<string, any> = Record<string, any>>(props: import("./types").Assign<({
    ...
    name: import("./types").FieldName<TFieldValues>;
    rules?: Partial<{
    ...
    control?: import("./types").Control<TFieldValues> | undefined;
}) | ({
    as?: undefined;
    render: (data: import("./types").ControllerRenderProps<TFieldValues>) => React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)>;
} & {
    name: import("./types").FieldName<TFieldValues>;
    rules?: Partial<{
        required: string | boolean | import("./types").ValidationValueMessage<boolean>;
