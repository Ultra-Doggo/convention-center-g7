...
var useFieldArray = function (_a) {
    ...
    var append = function (value, shouldFocus) {
        ...
        var updateFormValues = __spread(getCurrentFieldsValues(), mapIds(Array.isArray(value) ? value : [value], keyName));
        ...
        !shouldUnregister &&
            set(shallowFieldsStateRef.current, name, __spread((get(shallowFieldsStateRef.current, name) || []), [
                value,
            ]));
...
var Controller = function (props) {
    ...
    var field = useField(props).field;
